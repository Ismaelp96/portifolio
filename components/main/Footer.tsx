...
const Footer = () => {
  return (
    <footer className="relative h-full w-full bg-transparent px-5 py-8 text-gray-200 before:absolute before:left-0 before:top-0 before:h-[1px] before:w-full before:bg-[#2A0E61]/40 ">
        ...
        <div className="flex h-full w-full items-center">
          ...
          <nav className="mb-4 flex h-auto w-full items-center justify-around">
            <Link
              ...
              className="my-[15px] flex items-center transition-colors duration-300 hover:text-[#b49bff]"
            >
              <span className="ml-1.5 text-[15px]">Become Sponsor</span>
            </Link>
            <Link
              href={"#"}
              className="my-[15px] flex items-center transition-colors duration-300 hover:text-[#b49bff]"
            >
              <span className="ml-1.5 text-[15px]">Learning about me</span>
            </Link>
            <Link
              href={"#"}
              className="my-[15px] flex items-center transition-colors duration-300 hover:text-[#b49bff]"

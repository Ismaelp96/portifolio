...
const Encryption = () => {
  return (
    <section className="relative -mt-[360px] h-full min-h-screen w-full overflow-hidden lg:-mt-[240px]">
      <div className="absolute left-[50%] top-[18rem] z-20 w-full -translate-x-[50%] space-y-4 lg:space-y-2">
        <motion.div
      ...
      <video
        ...
        src="/encryption.mp4"
      />
      <div className="group absolute left-[50%] top-[66%] z-20 flex h-auto w-auto -translate-x-[50%] cursor-pointer flex-col items-center lg:top-[40%]">
        <Image
          src="/LockTop.png"
          alt="Lock top"
          width={50}
          height={50}
          className="w-[30px] translate-y-8 transition-all duration-200 group-hover:translate-y-11 lg:w-[76px]"
        />
        <Image
          src="/LockMain.png"
          alt="Lock Main"
          width={70}
          height={70}
          className="z-10 w-[46px] lg:w-[100px]"
        />
        <div className="Welcome-box  my-5 border border-[#7042f88b] px-[15px] py-1 opacity-[0.9]">
          <h2 className="Welcome-text text-xs lg:text-xl">🔐 Criptografia</h2>
        </div>
      </div>
    </section>
  );
